           ...
           or cfg.get_string("sound/type") == "fake-synth":
            ...
            if alsaseq:
                ...
                gu.dialog_ok(_("The pyalsa python module is missing"),
                    solfege.win,
                    _("Solfege was configured to the Python modules from www.alsa-project.org, but the modules was not found. You must reconfigure sound in the preferences window (Ctrl-F12) or restart Solfege in a way that it finds the module."))
                soundcard.initialise_using_fake_synth(True)
                if solfege.splash_win:
