...
class IntervalCheckBox(gtk.HBox):
    ...
    """
    max_interval = 16 # Major tenth
    def __init__(self):
        gtk.HBox.__init__(self)
        self.checkbox_dict = {}
        for x in range(1, self.max_interval + 1):
...
class MultipleIntervalConfigWidget(gtk.VBox, cfg.ConfigUtils):
    ...
    def __init__(self, exname):
        ...
        box.pack_start(gtk.Label(_("Number of intervals:")), False)
        ...
        box.pack_start(self.g_num_int_spin, False)
        ...
        box.pack_start(gtk.Label(
                _("Toggle buttons are for interval number:")), False)
        ...
        box.pack_start(self.g_int_sel_spin, False)
        table = gtk.Table()
